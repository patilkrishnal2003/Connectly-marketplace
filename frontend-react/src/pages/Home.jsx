...
import { ArrowRight, Layers, Sparkles, TrendingUp, Users } from "lucide-react";
  ...
  const ctaHighlights = [
    {
      ...
      desc: "Get guided activation and know which perks unlock in minutes."
    },
    {
      title: "Support from real humans",
      desc: "Concierge help to map deals to your stack and budget."
    },
    {
      title: "Flexible entry",
      desc: "Start with essentials and scale into custom enterprise perks."
    }
  ];
  const PLAN_OPTIONS = [
    {
